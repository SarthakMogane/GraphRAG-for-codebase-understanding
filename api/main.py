...
from generation.streaming_generator import StreamingGenerator, stream_to_sse
...
# llm = ChatGoogleGenerativeAI(api_key=key,model="gemini-2.5-flash-lite") # Use a dummy key if just testing the trace connection
# try:
...
#             "llm": state.pipeline.llm if state.pipeline else None
#         }
#     )
