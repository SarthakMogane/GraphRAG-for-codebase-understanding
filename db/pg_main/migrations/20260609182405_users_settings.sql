...
---RLS 
ALTER TABLE user_settings ENABLE ROW LEVEL SECURITY , FORCE ROW LEVEL SECURITY;
...
WITH CHECK (current_setting('app.is_auth_flow',true)= 'true');



-- migrate:down
ALTER TABLE user_settings DISABLE ROW LEVEL SECURITY, NO FORCE ROW LEVEL SECURITY;
